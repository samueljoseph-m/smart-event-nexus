        ...
        <div className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              ...
              <span className="block text-purple-600">Event Management</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Simplify task assignment, coordinate volunteers, and manage every detail with our AI-powered event management platform.
            </p>
            <div className="mt-10">
              {isAuthenticated ? (
                <Link to="/dashboard">
            ...
            <div className="mt-16">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <Card>
                  ...
                  <CardContent>
                    <p>Our AI-powered system automatically assigns tasks based on skills, availability, and roles.</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p>Give team members exactly the access they need based on their role in your organization.</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p>Track RSVPs, send reminders, and manage your guest lists all in one place.</p>
                  </CardContent>
                </Card>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-500 md:mt-0 md:order-1">
              &copy; 2024 Smart Event Manager. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
